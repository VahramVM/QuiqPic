...
var SiteLayoutComponent = /** @class */ (function () {
    ...
    SiteLayoutComponent.prototype.redirectToShop = function () {
    ...
    SiteLayoutComponent.prototype.initFromServer = function () {
        var _this = this;
        this.catecoriesService.Themes(this.category).subscribe(function (res) {
            _this.images = res;
            ...
            var uniqueAddresses = Array.from(new Set(addresses.map(function (a) { return a.name; })))
                .map(function (name) {
                return addresses.find(function (a) { return a.name === name; });
            });
    ...
    SiteLayoutComponent.prototype.valueChanged = function (e) {
    ...
    SiteLayoutComponent.prototype.ngAfterViewInit = function () {
        ...
        material_service_1.Material.zoomImg();
        material_service_1.Material.carousel();
        material_service_1.Material.selectOpt();
        material_service_1.Material.scrolSpy();
        material_service_1.Material.dropDown();
    ...
    SiteLayoutComponent.prototype.routerlink = function () {
    ...
    SiteLayoutComponent.prototype.moveWithFormat = function (a, b) {
    ...
    SiteLayoutComponent.prototype.productBrandColor = function () {
        ...
        this.productBrandColors = this.arrColor.filter(function (o1) { return productBrandColors.some(function (o2) { return o1 === o2; }); });
    };
    SiteLayoutComponent.prototype.productBrandSize = function () {
        var _this = this;
    ...
    SiteLayoutComponent.prototype.setLineHeight = function () {
    ...
    __decorate([
        core_1.ViewChild('imagePath')
    ], SiteLayoutComponent.prototype, "IMG");
    __decorate([
        core_1.ViewChild('coord')
    ], SiteLayoutComponent.prototype, "coord");
    __decorate([
        core_1.ViewChild('owlElement')
    ], SiteLayoutComponent.prototype, "owlElement");
    __decorate([
        core_1.ViewChild('inputColor')
    ], SiteLayoutComponent.prototype, "inputColor");
    __decorate([
    ...
    SiteLayoutComponent = __decorate([
        ...
        core_1.HostListener('window:load')
    ], SiteLayoutComponent);
