...
import { Images, Products, ProductsColor, Fonts, ProductBrand, OrderDatas } from '../../interface';
...
import { of, observable, Observable, Subscriber, fromEvent, Subject } from 'rxjs';
...
export class SiteLayoutComponent implements AfterViewInit {
  ...
  public categories = [];
  public arrColor = [];
  public productBrandColors = [];
  public productBrandSizes: {} = null; //new
  public allSizesByProductType: {} = null; //new
